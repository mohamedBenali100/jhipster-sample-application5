  ...
  describe('Alert Error Component', () => {
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [JhipsterSampleApplication5TestModule, TranslateModule.forRoot()],
    ...
    describe('Error Handling', () => {
      ...
      it('Should display an alert on generic error', () => {
        // GIVEN
        eventManager.broadcast({ name: 'jhipsterSampleApplication5App.httpError', content: { error: { message: 'Error Message' } } });
